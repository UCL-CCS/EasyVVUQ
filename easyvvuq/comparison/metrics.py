...
def hellinger(dist1, dist2):
    ...
    Return value is in range `[0, 1]`, where 0 is min distance: max similarity,
...
def kullback_leibler(dist1, dist2):
    ...
    Returns value in range [0, +inf) where values closer to 0 mean less distance (higher similarity).
    """
